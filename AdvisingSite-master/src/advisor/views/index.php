...
<html>
	...
	<div id="content-container">
		...
		<input type="text" name="mName" value="<?php echo (isset($_SESSION['mName']) ? $_SESSION['mName'] : ''); ?>">
      		<p><br></p>
		...
		<input type="text" name="bldgName" value="<?php echo (isset($_SESSION['bldgName']) ? $_SESSION['bldgName'] : ''); ?>">	
            	<?php
		...
		<input type="text" name="officeRm" value="<?php echo (isset($_SESSION['officeRm']) ? $_SESSION['officeRm'] : ''); ?>">
            	<?php
